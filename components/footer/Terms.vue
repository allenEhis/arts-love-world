<template>
  <div>
        ...
        <p>
          Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the www.artsloveworld.store
          website (the "Service") operated by Arts Love World ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          controlled by Arts Love World.
        </p>

        <p>
          Arts Love World has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any
          third party web sites or services. You further acknowledge and agree that Arts Love World shall not be responsible or liable,
        ...
        <h2>Delivery</h2>
        <p>
          The delivery of our products are strictly instant digitally download products of premium classic arts,
          There is no physical delivery at the moment
        </p>
        ...
        <p>
          ...
          try to provide at least 60 days notice prior to any new terms taking effect. What constitutes a material change will be determined
        ...
        <p>If you have any questions about these Terms, please contact us at artsloveworld@gmail.com</p>
