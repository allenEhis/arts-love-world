export const state = () => ({
  products: [
    {
      id: 1,
      title: "Arts Love World Gallery Tour Brochure",
...
export const getters = {
  ...
  isConditionsOpen: state => {
    return state.systemInfo.openConditionsModal;
  },
  quantity: state => {
...
export const mutations = {
  ...
  showConditionsModal: (state, show) => {
    state.systemInfo.openConditionsModal = show;
  },
